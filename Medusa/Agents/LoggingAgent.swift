...
public class LoggingAgent
    ...
    //
    //
    // Logging will outout a formatted string to the log file.
    // Log files are located in MEDUSA-HOME-DIRECTORY/Logs
    // Log file names are named "Medusa.DATE_TIME.log"
    //
    // Log file entries have the format "DD/MM/YYYY HH:MM:SS.ssssss: message; statistics"
    // where DD/MM/YYYY HH:MM:SS.ssssss is the date + space + time + .milliseconds"
    // Log messages will be filtered to change ";" to ",", "[" to "(", "]" to ")" and ":" to " " because the "[];:" characters are reserved for formatting the log message
    //
    //
