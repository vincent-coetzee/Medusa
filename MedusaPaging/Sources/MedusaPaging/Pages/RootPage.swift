...
public class RootPage: Page
    ...
    public static let kRootPageFirstBTreeRootPageOffset               = RootPage.kRootPageSystemModuleAddressOffset + MemoryLayout<Integer64>.size
    public static let kRootPageEndPageOffsetOffset                    = RootPage.kRootPageFirstBTreeRootPageOffset + MemoryLayout<Integer64>.size
    ...
    public var firstFreePageOffset: Integer64
        {
        get
            {
            self.buffer.load(fromByteOffset: Self.kRootPageFirstEmptyPageOffsetOffset, as: Integer64.self)
    ...
    public var firstBTreeRootPageOffset: Integer64
        {
        get
            {
            self.buffer.load(fromByteOffset: Self.kRootPageFirstBTreeRootPageOffset, as: Integer64.self)
            }
        set
            {
            self.buffer.storeBytes(of: newValue, toByteOffset: Self.kRootPageFirstBTreeRootPageOffset, as: Integer64.self)
            self.isDirty = true
            }
        }
